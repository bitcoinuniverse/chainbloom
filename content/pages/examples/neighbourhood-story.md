...
Where you would show live activity for the world — who added what, when — there is nothing to link to yet. The public index is not switched on. See [what is running](/docs/help/status), and keep the noticeboard list of transaction ids in the meantime.
