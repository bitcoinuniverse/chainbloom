...
description: A bounded, ordered, openly interpretable record behaves like a material you work with, not a platform you publish on. Holding a path is not a copyright claim.
...
:::lead
The interesting thing here is not that a record is permanent. It is that the record is bounded, strictly ordered, and openly interpretable. Those are three constraints you can compose with. ChainBloom is closer to a stretcher and a set of pigments than to a place you upload things.
:::
